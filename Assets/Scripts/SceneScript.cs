...
public class SceneScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown("r"))
        {
            ...
            {
                item.Player.transform.position = IniPos + new Vector3(-5 + 2.5f * characters.IndexOf(item), 0, 0);
            }
    ...
    private void RandomBonusSpawn()
    {
        ...
        {
            LBonus.Add(Instantiate(Bonus, new Vector3(Random.Range(-10, 10), Random.Range(-5, 5), 0), Quaternion.identity));
        }
    }
